...
\section{Functional Requirements Evaluation}
	...
	\paragraph{Key Bindings (\mref{tKeys})}
	\begin{enumerate}
		\item{KB1\\}
	...
	\end{enumerate}
	\subsection{Widget Callbacks (\mref{tClick})}
	\begin{enumerate}
		\item{WC1\\}
		Type: Functional, Dynamic, Manual
	...
	\paragraph{Card Selection (\mref{tCard})}
	\begin{enumerate}
		\item{PC1\\}
...
\subsection{Interoperability}
	...
	\paragraph{Operating System Compatibility (\mref{tOS})}
	\begin{enumerate}
		\item{OSX\\}
	...
	\paragraph{Portability (\mref{tPort})}
	\begin{enumerate}
		\item{PR1\\}
		Type: Structural, Dynamic, Manual
	...
	\subsection{Usability (\mref{tUse})}
	...
	\paragraph{Playability (\mref{tPlay})}
	\begin{enumerate}
		\item{UP1\\}
		Type: Structural, Dynamic, Manual
	...
	\subsection{Product Integrity (\mref{tInt})}
