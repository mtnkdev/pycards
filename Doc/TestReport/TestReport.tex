...
\section{Functional Requirements Evaluation}
	...
	\begin{description}
		\item[Key Bindings\refstepcounter{tnum} (\tthetnum \label{tKeys})]
	\end{description}
	...
	\refstepcounter{tnum} \label{tClick}
	...
	\begin{description}
		\item[Card Selection\refstepcounter{tnum} (\tthetnum \label{tCard})]
	\end{description}
...
\subsection{Interoperability}
	...
	\begin{description}
		\item[Operating System Compatibility\refstepcounter{tnum} (\tthetnum 
		\label{tOS})]
	\end{description}
	...
	\begin{description}
		\item[Portability\refstepcounter{tnum} (\tthetnum \label{tPort})]
	\end{description}
	\begin{enumerate}
		\item{PR1\\}
		Type: Structural, Dynamic, Manual
	...
	\refstepcounter{tnum} \label{tUse}
	...
	\begin{description}
		\item[Playability\refstepcounter{tnum} (\tthetnum \label{tPlay})]
	\end{description}
	\begin{enumerate}
		\item{UP1\\}
		Type: Structural, Dynamic, Manual
	...
	\refstepcounter{tnum} \label{tInt}
	...
	\refstepcounter{tnum} \label{tSec}
