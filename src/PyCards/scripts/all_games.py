...
'''
    ...
    if sort_by == 'id':
        get_games_func = GAME_DB.gamesIdSorted
    else:
        get_games_func = GAME_DB.gamesNameSorted
...
<body>
'''
    print '<b>Total games: %d</b>' % len(GAME_DB.gamesIdSorted())
