...
from pysollib.gametype import STYLE, FILTER
...
##                 r = EVENT_HANDLED
    ...
    def _addSelectGameMenu(self, menu):
        ...
        games = map(self.app.gdb.get, self.app.gdb.gamesNameSorted())
        ##games = tuple(games)
    ...
    def _addSelectMahjonggGameSubMenu(self, games, menu, command, variable):
        select_func = lambda gi: gi.game_type == STYLE.MAHJONGG
    ...
    def _addSelectCustomGameSubMenu(self, games, menu, command, variable):
        ...
        select_func = lambda gi: gi.game_type == STYLE.CUSTOM
