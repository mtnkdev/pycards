...
from gamedb import loadGame
from pysollib.gametype import SKILL
from util import *
from stack import *
...
SkillLevel = WizSetting(
    values_map = ((n_('Luck only'),    SKILL.LUCK),
                  (n_('Mostly luck'),  SKILL.MOSTLY_LUCK),
                  (n_('Balanced'),     SKILL.BALANCED),
                  (n_('Mostly skill'), SKILL.MOSTLY_SKILL),
                  (n_('Skill only'),   SKILL.SKILL),
                  ),
    default = n_('Balanced'),
    label = _('Skill level:'),
