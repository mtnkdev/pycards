...
class Stack:
    ...
    def __init__(self, _id, x, y, base, alternate, direction, pos, accept=True, offset=0, deck=False, sameSuit=False):
        ...
        ###self.isFilled = False        # if stack is at max
        
        # # Card restrictions on stack (-1 is no restriction)
        # suitRestrict    = -1 
        # colourRestrict    = -1 
        # rankRestrict    = -1
        # baseSuit        = -1
    ...
    #     self.suitRestrict    = restrictions[0]
    #     self.colourRestrict    = restrictions[1]
    #     self.rankRestrict    = restrictions[2]
    #     self.baseSuit        = restrictions[3]
    #     self.baseColour        = restrictions[4]
    #     self.baseRank        = restrictions[5]
    #     self.direction        = restrictions[6]
    #     self.mod            = restrictions[7]
    #     self.maxMove        = restrictions[8]
    #     self.maxAccept        = restrictions[9]
    #     self.maxCards        = restrictions[10]
    #     self.minMove        = restrictions[11]
    #     self.minAccept        = restrictions[12]
    #     self.minCards        = restrictions[13]
