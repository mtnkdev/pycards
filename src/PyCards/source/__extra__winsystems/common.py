...
from source.settings import TITLE
from source.settings import VERSION
from source.settings import TOOLKIT, USE_TILE
from source.settings import DEBUG
from source.mfxutil import print_err
if USE_TILE:
    from source.tile import ttk
