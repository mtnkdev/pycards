...
##    replace(filename, "from source.gametype import STYLE, SKILL", "from source.gametype import STYLE, SKILL")
##    replace(filename, "from source.gametype import STYLE, SKILL", "from source.gametype import STYLE, SKILL")
##    replace(filename, "from source.gametype import GI", "from source import gametype")

    replace(filename, "si={\"ncards\": ", "numcards=")
import os
