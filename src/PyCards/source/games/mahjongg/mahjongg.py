...
from source import gametype
from source.util import *
from source.mfxutil import kwdefault, Struct, Image
from source.stack import *
from source.game import Game
from source.layout import Layout
from source.hint import AbstractHint, DefaultHint, CautiousDefaultHint
from source.settings import TOOLKIT, DEBUG
from source.pysoltk import MfxCanvasText, MfxCanvasImage
from source.pysoltk import bind, EVENT_HANDLED, ANCHOR_NW
from source.pysoltk import MfxMessageDialog
...
def r(id, short_name, name=None, ncards=144, layout=None):
    ...
    gi = GameInfo(id, gameclass, name,
                  STYLE.MAHJONGG, 4*decks, 0, ##SKILL.MOSTLY_SKILL,
                  category=CATEGORY.MAHJONGG, short_name=short_name,
